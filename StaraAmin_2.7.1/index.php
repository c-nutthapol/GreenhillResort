...
<head>
	...
	<!-- inject:css  ../assets/css/shared/style.css-->
				...
				<ul class="navbar-nav navbar-nav-right">
					...
					<li class="nav-item dropdown d-none d-xl-inline-block">
						<a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown"
							aria-expanded="false">
							<span class="profile-text">Hello, <?php echo $_SESSION['fname']; ?> !</span>
						...
						<div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
							...
							<a href="pages/signin-signup/signout.php" class="dropdown-item"> Sign Out </a>
						</div>
					</li>
				</ul>
		...
		<div class="container-fluid page-body-wrapper">
			...
			<nav class="sidebar sidebar-offcanvas" id="sidebar">
				<ul class="nav">
					...
					<li class="nav-item">
						<a class="nav-link" href="pages/layout/travel.html">
							<i class="menu-icon mdi mdi-notification-clear-all"></i>
							<span class="menu-title">จัดการสถานที่ท่องเที่ยว</span>
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="pages/layout/rooms.html">
							<i class="menu-icon mdi mdi-notification-clear-all"></i>
							<span class="menu-title">จักการห้องพักทั้งหมด</span>
						</a>
					</li>
					<!-- <li class="nav-item">
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="add-items d-flex">
										...
										<button class="add btn btn-primary font-weight-medium todo-list-add-btn">
											Add
										</button>
									</div>
										...
										<div class="row ticket-card mt-3 pb-2 border-bottom pb-3 mb-3">
											...
											<div class="ticket-details col-md-9">
												...
												<p class="text-gray ellipsis mb-2">
													Donec rutrum congue leo eget malesuada. Quisque
											...
											<div class="ticket-actions col-md-2">
												<div class="btn-group dropdown">
													...
													<div class="dropdown-menu">
														...
														<a class="dropdown-item" href="#">
															<i class="fa fa-history fa-fw"></i>Another
															action</a>
														<div class="dropdown-divider"></div>
														<a class="dropdown-item" href="#">
										...
										<div class="row ticket-card mt-3">
											...
											<div class="ticket-details col-md-9">
												...
												<p class="text-gray ellipsis mb-2">
													...
													eget tortor risus. Lorem ipsum dolor sit amet.
												</p>
												<div class="row text-gray d-md-flex d-none">
													<div class="col-4 d-flex">
														<small class="mb-0 mr-2 text-muted">Last responded :</small>
